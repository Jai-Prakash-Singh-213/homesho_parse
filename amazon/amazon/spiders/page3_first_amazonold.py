...
def main(line, f3):
   ...
   if tag_span_see_more is not None:
	   ...
	   bt = al.span.get_text().encode("ascii", "ignore").strip()
           #logging.debug([menu, ctlink, cttitle, sctlink, scttitle, bl, bt])
           filedata = [menu, ctlink, cttitle, sctlink, scttitle, bl, bt]
           filedata2 = map(mystrip, filedata)
           logging.debug(filedata2)
           f4 = open(f3, "a+")
...
if __name__=="__main__":
    line = "['Handbags & Luggage', 'http://www.amazon.in/Bags-Briefcases/b/ref=sd_allcat_lug_briefcases/276-6718833-1247838?ie=UTF8&node=2917431031', 'Bags & Briefcases', 'http://www.amazon.in/s/ref=lp_2917431031_nr_n_1/276-6718833-1247838?rh=n%3A2454169031%2Cn%3A%212454170031%2Cn%3A2917431031%2Cn%3A2917439031&bbn=2917431031&ie=UTF8&qid=1394881749&rnid=2917431031', 'Canvas & Beach Tote Bags(103)']"
